...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-12">
    <div class="container mx-auto px-6">
        <div class="mb-10 text-center">
            <h1 class="text-4xl font-extrabold text-royal-blue-700">Modifier un rôle</h1>
            <p class="text-gray-600 mt-3">Mettez à jour les informations du rôle</p>
        </div>

        <div class="bg-white rounded-xl shadow-xl p-8 max-w-2xl mx-auto border border-gray-200">
            <form method="POST" action="{{ route('roles.update', $role->id ?? 0) }}" class="space-y-6">
                @csrf
                @method('PUT')
