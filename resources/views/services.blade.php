    ...
    <div class="container mx-auto px-6">
        <div class="grid md:grid-cols-3 gap-6">
            <div class="bg-white rounded-2xl shadow-xl p-8 text-center">
                ...
                <p class="text-gray-500 mt-2">Services disponibles</p>
            </div>

            <div class="bg-white rounded-2xl shadow-xl p-8 text-center">
                <h2 class="text-4xl font-bold text-blue-700">24/7</h2>
                <p class="text-gray-500 mt-2">Plateforme disponible</p>
            </div>

            <div class="bg-white rounded-2xl shadow-xl p-8 text-center">
                <h2 class="text-4xl font-bold text-blue-700">100%</h2>
                <p class="text-gray-500 mt-2">Suivi en ligne</p>
            </div>
        </div>
    </div>
</section>
...
<section class="pb-24">
    <div class="container mx-auto px-6">
        <div class="flex justify-between items-center mb-12">
            <div>
                <h2 class="text-4xl font-bold text-gray-800">Services disponibles</h2>
                <p class="text-gray-500 mt-2">Choisissez un service pour déposer une plainte.</p>
            </div>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            @foreach($services as $service)
                <div class="bg-white rounded-3xl border shadow-lg hover:shadow-2xl hover:-translate-y-2 transition duration-300 overflow-hidden">
                    ...
                    <h3 class="text-2xl font-bold mt-8">{{ $service->name }}</h3>
                    <p class="text-gray-600 mt-4 leading-7">{{ $service->description }}</p>
